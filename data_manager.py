...
class DataManager:
    ...
    def load_entries(self, sort_by='date', order='desc', limit=None, offset=0):
        ...
        try:
            ...
            query = f'SELECT id, date, person, description, amount, type, created_at FROM entries ORDER BY {sort_by} {order}'
    ...
    def search_entries(self, query, fields=None):
        ...
        try:
            ...
            query_str = 'SELECT id, date, person, description, amount, type, created_at FROM entries WHERE ' + ' OR '.join(conditions)
    ...
    def query_by_date(self, start_date, end_date):
        ...
        try:
            ...
            cursor = conn.cursor()
            cursor.execute('''
                SELECT id, date, person, description, amount, type, created_at 
                FROM entries 
